...
class __TwigTemplate_978cee016ef0ef735b755358c4d1fd818b55c1a52eb23019b75b2043e0063420 extends Twig_Template
{
...
";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute(($context["pages"] ?? null), "find", array(0 => "/blog/hackerx-jakarta-my-experience"), "method"), "media", array()), "images", array()));
        foreach ($context['_seq'] as $context["_key"] => $context["image"]) {
            // line 29
            echo "    ";
            echo $this->getAttribute($this->getAttribute($context["image"], "cache", array()), "url", array());
            echo "
";
        }
...
{% for image in pages.find('/blog/hackerx-jakarta-my-experience').media.images %}
    {{ image.cache.url }}
{% endfor %}", "@Page:C:/xampp7/htdocs/ajibari.com/user/pages/01.blog/hackerx-jakarta-my-experience", "");
    }
}
